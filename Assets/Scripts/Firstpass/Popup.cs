...
{
	public Vector2 OnPos = new Vector2(-482f, 254f);

	public Vector2 OffPos = new Vector2(-482f, 254f);
	...
	{
		On();
		Material material = old.transform.GetComponent<Renderer>().material;
		Material material2 = current.transform.GetComponent<Renderer>().material;
		oldIcon.GetComponent<Renderer>().material = material;
		newIcon.GetComponent<Renderer>().material = material2;
