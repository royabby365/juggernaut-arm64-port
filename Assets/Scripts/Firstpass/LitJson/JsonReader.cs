...
public class JsonReader
{
	...
	private List<int> automaton_stack;
	...
	private JsonReader(TextReader reader, bool owned)
	{
		...
		automaton_stack.Add(65553);
		automaton_stack.Add(65543);
	...
	public bool Read()
	{
		...
		while (true)
		{
			if (parser_return)
			{
				if (automaton_stack[0] == 65553)
				{
					end_of_json = true;
				}
				return true;
			}
			current_symbol = automaton_stack[0];
			automaton_stack.RemoveAt(0);
			ProcessSymbol();
